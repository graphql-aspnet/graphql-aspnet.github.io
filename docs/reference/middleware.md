...
12. `PackageQueryResultMiddleware`: Performs a final set of checks on the resolved field data and generates an `IQueryExecutionResult` for the query.
...
```csharp title="QueryExecutionContext.cs"
